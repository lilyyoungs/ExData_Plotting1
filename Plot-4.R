...
par(mfrow=c(2,2))
plot(PowerData2017Feb$date_time,PowerData2017Feb$Global_active_power, type="l",xlab="", ylab="Global Active Power)")
plot(PowerData2017Feb$date_time,PowerData2017Feb$Voltage, type="l",xlab="datetime", ylab="Voltage)")
plot(PowerData2017Feb$date_time,PowerData2017Feb$Sub_metering_1, type="s",xlab="", ylab="Energy sub metering)")
...
plot(PowerData2017Feb$date_time,PowerData2017Feb$Global_reactive_power, type="l",xlab="", ylab="Global_reactive_power)")
dev.off()
